...
/**
 ...
 [QDiDiUserOpStatistics accumulateEvent:@"NavRouteCalculate"];
 2.统计路线规划的总次数，并要区分初次规划和偏航规划的占比,isOutway表示是否偏航，取值区间为[YES,NO];
 [QDiDiUserOpStatistics accumulateEvent:@"NavRouteCalculate" detail:[NSDictionary dictionaryWithObject:@"YES" forKey:@"isOutway"]];
 3.统计路线规划的总次数，并要区分初次规划和偏航规划的占比,导航使用场景，isOutway表示是否偏航，取值区间为[YES,NO]， scene表示导航场景，取值区间为[sctx,normal,yzx],分别表示司乘同显，普通导航，一致性;
 [QDiDiUserOpStatistics accumulateEvent:@"NavRouteCalculate" detail:[NSDictionary dictionaryWithObjects:@[@"YES", @"sctx"] forKeys:@[@"isOutway", @"scene"]]];
 ...
 [QDiDiUserOpStatistics accumulateEvent:@"NavRouteCalculate" detail:[NSDictionary dictionaryWithObjects:@[@"YES", @"sctx"] forKeys:@[@"isOutway", @"scene"]] isSuccess:YES consumeTime:0.3];
*/
...
@interface QDiDiUserOpStatistics (SCTX)
